...
public class NQueensTest
{
    ...
    public void TestCorrectSolution()
    {
        ...
        Assert.Equal(4, solution["0"].InstantiatedValue);
        Assert.Equal(6, solution["1"].InstantiatedValue);
        Assert.Equal(1, solution["2"].InstantiatedValue);
        Assert.Equal(5, solution["3"].InstantiatedValue);
        Assert.Equal(2, solution["4"].InstantiatedValue);
        Assert.Equal(0, solution["5"].InstantiatedValue);
        Assert.Equal(7, solution["6"].InstantiatedValue);
